...
\begin{itemize}
	\item Managing up to 3 concurrent engineering squads.
	\item Building new cross-functional teams from scratch, establishing roadmaps, ways of working and technical strategies.
	...
	\item Managing Technical Incidents, both Operational \& Security.
	...
	\item Planning and co-ordinating large scale technical migrations, in particular towards cloud and SaaS platforms.
\end{itemize}
...
\begin{itemize}
	\item Built a new centralised cyber security function, bringing together people, process and budgets from across the organisation.  This reduced barriers in communication and led to better-aligned security outcomes.
