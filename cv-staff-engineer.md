...
Hands-on technical leader. Continuous principal-engineer-level technical direction since 2018 — across cyber security, reliability engineering and platform architecture — held alongside management responsibilities. Particular strengths in mission-critical systems, large-scale technical migrations, and bridging business and engineering at all levels. Now seeking a Staff Engineer role to focus deeply on hands-on architecture and engineering.
...
**Technical leadership** — Architecture & target-system design, technical strategy, mentorship of senior engineers, technical documentation & standards, stakeholder management, influence without authority

**Programming & systems** — Python, JavaScript / Node.js, Golang, PHP, Unix/Linux

**Engineering practice** — Agile, Scrum, TDD, BDD, CI/CD, microservices, mission-critical systems, large-scale technical migrations

**Cloud & platform** — AWS, observability, monitoring, site reliability engineering, incident management

**Generative AI** — Agentic coding agents, LLM agent orchestration, agent guardrails, MCP (Model Context Protocol), Anthropic Agent SDK

**Cyber security** — Security strategy, security incident response, application security, identity & SSO, risk management
...
- Held the unbackfilled Principal Engineer responsibilities for Cyber Security throughout this period — providing the technical direction that role usually requires, while delegating day-to-day team management to senior engineers on the team.
