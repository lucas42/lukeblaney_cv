...
Senior engineering leader with director-level experience running multiple cross-functional teams through senior tech and team leads. Strong architecture and distributed-systems background, built across publishing-platform, reliability engineering and cyber security at the Financial Times. Comfortable bridging hands-on architectural decisions and people leadership at all levels — from junior engineers through to the Management Board.
...
**Engineering leadership** — Director-level multi-team leadership; leading through senior tech and team leads; mentorship of senior engineers; product partnership; stakeholder management at all organisational levels

**Architecture & distributed systems** — Event-driven architecture; Apache Kafka; real-time data processing; microservices; API-first design; REST APIs; system design under ambiguity

**Programming & systems** — Python, JavaScript / Node.js, PHP, Golang, Unix/Linux

**Engineering practice** — Agile, Scrum, TDD, CI/CD; mission-critical systems; large-scale technical migrations

**Data & platform** — MySQL, PostgreSQL, Memcache; AWS; observability; site reliability engineering; incident management

**Cyber security** — Security strategy; security incident response; identity & SSO; risk management
...
Set strategic direction for cyber security at the FT, leading the function through senior tech and team leads.

- Held the unbackfilled Principal Engineer responsibilities for Cyber Security throughout this period — providing the technical direction the role usually requires alongside the director-level leadership work, while delegating day-to-day team management to senior engineers on the team.
- Defined the vision and set the strategy for IT Risk and Cyber Security, translating business goals into a target state and roadmap.
- Senior stakeholder management — acting as a bridge between business colleagues and engineers, presenting risks and trade-offs to audiences at all organisational levels.
...
Led the company's cyber security function through a period of organisational change, working through senior engineers and risk/governance leads.

- Retained the Principal Engineer technical-direction responsibilities for Cyber Security throughout this period, as the PE role had not been backfilled when I moved up.
