...
\item Financial Times: September 2020 - Present
\subsection*{Principal Engineer - Cyber Security (interim)}
\begin{detail}
A 4 month secondment, covering whilst key leadership roles were vacant.

\begin{itemize}
	\item Led and line managed the engineering function of the cyber security team.
	\item Managed security incidents across all parts of the business and collaborated with the Operations team to improve incident processes.
	...
	\item Guided technical and architectual decisions within the security team.
	\item Advised on security related concerns across all the FT's engineering teams and throughout the wider company too.
\end{itemize}
\end{detail}
