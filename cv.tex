...
Working on our Universal Publishing Platform, delivering Content \& Metadata from a range of editorial tools to our websites, apps and third-party B2B clients.  In this role, I'm responsible for architectural decisions across 6 development teams (approximately 50 developers in 2 countries).  I also work closely with product owners, editorial stakeholders and developers in other teams who interact with our platform.
\end{itemize}

\item Financial Times: December 2015 - October 2016
\begin{itemize}\item
 {\bf Platform Architect - Operational Intelligence}\\
I was technical lead on a team looking after monitoring, metrics \& log aggregation tools. Architected a new API-driven system for keeping track of our systems with automated runbook creation and monitoring management.  My role was a mixture of system design and development, mainly focused on front-end development to cover a skills gap within the team.  Was also heavily involved in the recruitment of new developers.
\end{itemize}
